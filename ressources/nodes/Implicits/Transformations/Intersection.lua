...
bbox_min = v(math.max(bbox_min1.x, bbox_min2.x), math.max(bbox_min1.y, bbox_min2.y), math.max(bbox_min1.z, bbox_min2.z))
bbox_max = v(math.min(bbox_max1.x, bbox_max2.x), math.min(bbox_max1.y, bbox_max2.y), math.min(bbox_max1.z, bbox_max2.z))
